		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='/_14_shopAP/ShopListController' />">票卷販售</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value='/_14_shopAP/ShopListController' />">得藝洋行</a></li>
				<li class="nav-item"><a class="nav-link"
			...
			<div>
				<ul class="navbar-nav mr-auto">
					<li class="nav-item"><a class="nav-link"
						href="<c:url value='/adminEnterMemberArea'/>"><img style='display:block; width:64px;height:36px;' src="data:image/jpeg;base64, ${sessionScope.memberPic}" >${sessionScope.member.getName()}</a></li>
					<li class="nav-item"><a class="nav-link"
